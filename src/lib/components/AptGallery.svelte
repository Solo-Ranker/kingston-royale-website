<section id="section-gallery" class="bg-dark-2 relative">
	<div class="relative z-2 container">
		<div class="row g-4 gx-5 justify-content-center">
			<div class="col-lg-6 text-center">
				<div class="subtitle s2 fadeInUp mb-3" data-wow-delay=".0s">Dicover Gallery</div>
				<h2 class="fadeInUp" data-wow-delay=".2s">Apartment Gallery</h2>
			</div>
		</div>

		<div class="row">
			<div class="col-md-12 text-center">
				<ul id="filters" class="fadeInUp" data-wow-delay="0s">
					<li><a href="#" data-filter="*" class="selected">Show All</a></li>
					<li><a href="#" data-filter=".view">View</a></li>
